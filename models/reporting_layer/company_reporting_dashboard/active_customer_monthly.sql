with active_customers_current_week_t_0 as
   ...
   , current_week_t_0 as (
	                         ...
	                         SELECT count( distinct id_customer )                                 AS "count"
			                      , 'KIP'                                                                   "app"
			                      , max( concat( extract( 'month' from NOW( ) - '0 week':: interval ), '-',
			                                     extract( 'year' from NOW( ) - '0 week':: interval ) ) ) as "Week of the Year"
			                      , extract( 'month' from NOW( ) - '0 week':: interval )                     "month"
			                      , extract( 'year' from NOW( ) - '0 week':: interval )                     "Year"
